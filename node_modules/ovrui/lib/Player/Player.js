...
var Player = function () {
  ...
  function Player() {
    ...
    if (!this._camera) {
      ...
      // VRDisplay renders.
      this._camera = new _ThreeShim2.default.PerspectiveCamera(60, width / height, 0.01, 10000.0);
    }
    this._initialAngles = {
    ...
    this.controls = new _AppControls2.default(this._camera, this.glRenderer.domElement);
    ...
    if ('getVRDisplays' in navigator) {
      navigator.getVRDisplays().then(function (displays) {
        if (displays.length) {
          ...
          _this.effect = new _VREffect2.default(_this.glRenderer, _this.vrDisplay);
