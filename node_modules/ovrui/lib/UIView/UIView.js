...
UIView.prototype = Object.assign(Object.create(_ThreeShim2.default.Object3D.prototype), {
  ...
  shouldAcceptHitEvent: function shouldAcceptHitEvent() {
    ...
    if (this.pointerEvents === _UIViewUtil.PointerEvents.NONE || this.pointerEvents === _UIViewUtil.PointerEvents.BOX_NONE) {
      return false;
    }
    return true;
  },
  ...
  shouldInterceptHitEvent: function shouldInterceptHitEvent() {
    ...
    if (this.pointerEvents === _UIViewUtil.PointerEvents.NONE || this.pointerEvents === _UIViewUtil.PointerEvents.BOX_ONLY) {
      return true;
    }
    return false;
  },
